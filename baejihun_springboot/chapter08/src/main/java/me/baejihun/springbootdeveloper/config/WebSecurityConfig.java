package me.baejihun.springbootdeveloper.config;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import me.baejihun.springbootdeveloper.service.UserDetailService;
...
/*
    ...
    2. 특정 HTTP 요청에 대한 웹 기 반 보안을 구성. 이 메서드에서 인증 / 인가 및 로그인, 로그아웃
    ...
    5. 로그아웃 설정.
        ...
        invalidHttpSession() : 로그아웃 이후에 세션을 전체 삭제할지 여부를 설정 -> 저희는 true를 설정

    6. csrf 설정을 비활성화 - CSRF 공격을 방지하기 위해서 사용하는건데, 실습 좀 편하게 하려고 비활성화 해놨음.
        (정보처리기사에서 본적 있음)
    7. 인증 관리자 관련 설정. 사용자 정보를 가 져올 서비스를 재정의하거나, 인증 방법, 예를 들어
