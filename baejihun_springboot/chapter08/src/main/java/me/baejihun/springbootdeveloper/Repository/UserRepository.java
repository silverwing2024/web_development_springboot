package me.baejihun.springbootdeveloper.Repository;

import me.baejihun.springbootdeveloper.domain.User;
...
/*
    이메일로 사용자를 식별, 즉 email을 username으로 봐도 됩니다. 따라서 사용자 정보를 가져오기 위해서는
