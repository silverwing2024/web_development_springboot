...
@EnableJpaAuditing      //created_at과 updated_at을 자동 업데이트해주는 애너테이션
...
/*
    1. 사전 지식 : 타임리프(Thymeleaf)
        ...
        * 템플릿 엔진: 스프링 서버에서 데이터를 받아 우리가 보는 웹 페이지, 즉 HTML 상에서
        ...
        h1 태그에서는 ${이름}이 텍스트 어트리뷰트(속성)으로 할당되있습니다.
        p 태그도 비슷한 상황입낟.
        ...
        값이 달라지면 그때 그때 화면에 반영하니 동적인 웹 페이지를 만들 수 있게 되는 것입니다.

        템플릿 엔진은 각각 문버빙 조금씩 다른 편입니다. 그래서 템플릿 엔진마다 문법을 새로 배워야 하는
        ...
        타임리프 표현식과 문법
            ...
            구체적인 사용 방법은 실습으로 알아볼 겁니다.

            이하에서 소개하는 표현식들을 전달받은 데이터를 사용자들이 볼 수 있게
